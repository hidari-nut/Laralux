...
--
-- Table structure for table `associated_stafs`
--

DROP TABLE IF EXISTS `associated_stafs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `associated_stafs` (
  ...
  PRIMARY KEY (`id`),
  KEY `associated_stafs_ibfk_1` (`hotel_id`),
  KEY `associated_stafs_ibfk_2` (`user_id`),
  CONSTRAINT `associated_stafs_ibfk_1` FOREIGN KEY (`hotel_id`) REFERENCES `hotels` (`id`),
  CONSTRAINT `associated_stafs_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `associated_stafs`
--

LOCK TABLES `associated_stafs` WRITE;
/*!40000 ALTER TABLE `associated_stafs` DISABLE KEYS */;
INSERT INTO `associated_stafs` VALUES (1,1,1,NULL,NULL,NULL),(2,2,2,NULL,NULL,NULL),(3,3,3,NULL,NULL,NULL),(4,4,4,NULL,NULL,NULL),(5,5,5,NULL,NULL,NULL),(6,6,6,NULL,NULL,NULL),(7,7,7,NULL,NULL,NULL),(8,8,8,NULL,NULL,NULL),(9,9,9,NULL,NULL,NULL),(10,10,10,NULL,NULL,NULL),(11,11,11,NULL,NULL,NULL),(12,12,12,NULL,NULL,NULL),(13,13,13,NULL,NULL,NULL),(14,14,14,NULL,NULL,NULL),(15,15,15,NULL,NULL,NULL),(16,16,16,NULL,NULL,NULL),(17,17,17,NULL,NULL,NULL),(18,18,18,NULL,NULL,NULL),(19,19,19,NULL,NULL,NULL),(20,20,20,NULL,NULL,NULL),(21,21,21,NULL,NULL,NULL),(22,22,22,NULL,NULL,NULL),(23,23,23,NULL,NULL,NULL);
/*!40000 ALTER TABLE `associated_stafs` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `roles` VALUES (1,'Owner',NULL,NULL,NULL),(2,'Staf',NULL,NULL,NULL),(3,'Customer',NULL,NULL,NULL);
...
-- Dump completed on 2024-06-25  2:53:35
